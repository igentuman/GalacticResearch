 ...
 * @author micdoodle8
 */
public class SoundUpdaterSatellite extends MovingSound {
	private final EntityPlayerSP thePlayer;
	private final EntitySatelliteRocket theRocket;
	private boolean soundStopped;
	private boolean ignition = false;

	public SoundUpdaterSatellite(EntityPlayerSP par1EntityPlayerSP, EntitySatelliteRocket par2Entity) {
