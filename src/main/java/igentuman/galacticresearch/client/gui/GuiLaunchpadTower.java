...
public class GuiLaunchpadTower extends GuiContainerGC {
    public static final ResourceLocation loaderTexture = new ResourceLocation("galacticraftcore", "textures/gui/cargo_loader.png");
    private final TileLaunchpadTower cargoLoader;
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        switch(par1GuiButton.id) {
            case 0:
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(PacketSimple.EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, GCCoreUtil.getDimensionID(this.cargoLoader.getWorld()), new Object[]{this.cargoLoader.getPos(), 0}));
            default:
        }
    }
    ...
    public void initGui() {
        ...
        electricityDesc.add(EnumColor.YELLOW + GCCoreUtil.translate("gui.energy_storage.desc.1") + (int)Math.floor((double)this.cargoLoader.getEnergyStoredGC()) + " / " + (int)Math.floor((double)this.cargoLoader.getMaxEnergyStoredGC()));
