...
public class SatelliteRocketRecipeCategory implements IRecipeCategory
{

    private static final ResourceLocation rocketGuiTexture = new ResourceLocation(MODID, "textures/gui/schematic/satellite_rocket.png");

    @Nonnull private final IDrawable background;
    @Nonnull private final String localizedName;
    public static String ID = MODID+"satellite";
