...
public class ContainerSchematicMiningRocket extends Container
{
    ...
    public ContainerSchematicMiningRocket(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        ...
        int slotId = 1;
        // Cone
        this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId++, 48, 9 + change, pos, par1InventoryPlayer.player));

        this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId++, 48, 9 + 18 + change, pos, par1InventoryPlayer.player));

        // Body
        for (var6 = 1; var6 < 3; ++var6)
        {
            this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId++, 39, -7 + var6 * 18 + 16 + 18 + change, pos, par1InventoryPlayer.player));
        }

        // Body Right
        for (var6 = 1; var6 < 3; ++var6)
        {
            this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId++, 57, -7 + var6 * 18 + 16 + 18 + change, pos, par1InventoryPlayer.player));
        }

        // Left fins
        this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId++, 30, 81 + change, pos, par1InventoryPlayer.player));

        // Engine
        this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId++, 48, 81 + change, pos, par1InventoryPlayer.player));

        // Right fins
        this.addSlotToContainer(new SlotSchematicMiningRocket(this.craftMatrix, slotId, 66, 81 + change, pos, par1InventoryPlayer.player));
