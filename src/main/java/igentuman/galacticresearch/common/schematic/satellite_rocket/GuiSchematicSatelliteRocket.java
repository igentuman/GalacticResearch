...
public class GuiSchematicSatelliteRocket extends GuiPositionedContainer implements ISchematicResultPage
{
    ...
    private static final ResourceLocation texture = new ResourceLocation(GalacticResearch.MODID, "textures/gui/schematic/satellite_rocket.png");
    ...
    {
        this.fontRenderer.drawString(GCCoreUtil.translate("item.satellite_rocket.name"), 7, -20 + 27, 4210752);
